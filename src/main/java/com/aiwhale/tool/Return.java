...
public class Return extends HashMap<String, Object> {
    ...
    public Integer get_code() {
        return (Integer) this.getOrDefault(Return_Fields.code.name(), Code.INTERNAL_SERVER_ERROR.code);
    }
    ...
    public String toJson() {
        try {
            ...
            return JsonConvert.toJson(Return.FAIL(Code.INTERNAL_SERVER_ERROR));
        }
    }
}
